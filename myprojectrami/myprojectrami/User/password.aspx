<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="password.aspx.cs" Inherits="password" %>
...
<body>
    ...
    <table style="margin:auto;">
         ...
         <th>
              ...
              <form action="password.aspx" runat="server"  method="post" onsubmit="return Valid()" >
              
                   <div class="card" style="margin: auto; margin-top:109px;">
                
                             <h1 style="font-size:22px; margin-left:30px; margin-top:50px; text-align:center;">Change Password</h1>
                 
                     <table>
                         <tr>
                             <td><input style="width: 316px; height: 46px;  border: solid 1px; float:left; margin-left:15px; margin-top:50px;" type="password" name="oldpass" id="oldpass"  placeholder="CURRENT PASSWORD"/></td>
                         </tr>
                          <tr>
                             <td><input style="width: 316px; height: 46px;  border: solid 1px; float:left; margin-left:15px; margin-top:35px;" type="password" name="newpass" id="newpass" placeholder="NEW PASSWORD"/></td>
                         </tr>
                          <tr>
                             <td><input style="width: 316px; height: 46px;  border: solid 1px; float:left; margin-left:15px; margin-top:35px;" type="password" name="connewpass" id="connewpass" placeholder="CONFIRM NEW PASSWORD"/></td>
                         </tr>
                         <tr>
...
<script type="text/javascript" src="../JavaScripts/password.js"></script>