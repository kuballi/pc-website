...
public partial class searchbygender : System.Web.UI.Page
{
    public string tb = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack)
        {
            ...
            string gender = Request.Form["gender1"];
            string stUser = "SELECT tblUsers.UserName, tblUsers.FirstName, tblUsers.LastName, tblUsers.Phonenumber, tblUsers.Email, tblUsers.Gender, tblUsers.City, tblUsers.Pass, tblUsers.UserType FROM tblUsers WHERE (((tblUsers.Gender)= " + gender + ")); ";
            dsUser = sqlHelper.GetData(stUser);
            if (dsUser.Tables[0].Rows.Count > 0)
            {
                SearchByGender1.Visible = true;
                results3.Visible = false;
