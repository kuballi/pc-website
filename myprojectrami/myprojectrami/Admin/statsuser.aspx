<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="statsuser.aspx.cs" Inherits="statsuser" %>
...
<nav>
    ...
    <form  id="form1" runat="server" action="statsuser.aspx" style="margin-top:50px;"  method="post"  oninput="searchuser.aspx">
      <center>
             ...
             <input  type="search" name="search" id="d" placeholder="Search user by a username..."  onmouseout="myFunction()"/>
          </center>
        </form>
                          
           <asp:Panel ID="Tableshow" Visible="False" runat="server">
           <h1 class="titel">User stats</h1>
            ...
            <asp:Content><table><%=tb%></table></asp:Content>
               ...
               <center>
        <asp:label text="No results" runat="server"  Visible="False" ID="results" Font-Bold="True" Font-Size="Larger" />
